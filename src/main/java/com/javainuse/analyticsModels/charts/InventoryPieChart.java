...
//
//public class InventoryPieChart implements List<InventoryPieChart> {
//    private  String name;
...
//
//    public InventoryPieChart() {
//        super();
//    }
//
//    public InventoryPieChart(String name, Integer population, String color, String legendFontColor, Integer legendFontSize) {
//        this.name = name;
