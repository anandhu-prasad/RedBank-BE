...
public class UpcomingDrivesDAO {
    ...
    public ResponseEntity<List<UpcomingDrives_RespBody>> getDrives(UpcomingDrives_ReqBody data, String userId, int userType) {
        ...
        HttpHeaders responseHeaders = new HttpHeaders();
            ...
            if(userType == 1){
                ...
                return ResponseEntity.ok().headers(responseHeaders).body(resultsList);
    ...
    public ResponseEntity<?> registerForDrive(String userId, String driveId, int userType){
