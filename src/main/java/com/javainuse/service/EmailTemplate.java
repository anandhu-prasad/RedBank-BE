...
//This class is for SenfOtp.html
public class EmailTemplate {
    ...
    private String loadTemplate(String customtemplate) throws Exception {
        ...
        //This will return the path of SendOtp.html is stored and will be passed as file
        File file = new File(classLoader.getResource(customtemplate).getFile());
        String content = "Empty";
        try {
            //This will read the content of the SendOtp.html
    ...
    public String getTemplate(Map<String, String> replacements) {
        ...
        //Replace the String and the username and OTP value is shown in the E-Mail
