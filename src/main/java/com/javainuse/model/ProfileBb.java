...
public class ProfileBb {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "profile_bb_seq")
    @GenericGenerator(name = "profile_bb_seq", strategy = "com.javainuse.util.StringSequenceIdentifier", parameters = {
