...
public class ProfileHos {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "profile_hos_seq")
    @GenericGenerator(name = "profile_hos_seq", strategy = "com.javainuse.util.StringSequenceIdentifier", parameters = {
