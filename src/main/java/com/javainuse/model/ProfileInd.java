...
public class ProfileInd {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "profile_ind_seq")
    @GenericGenerator(name = "profile_ind_seq", strategy = "com.javainuse.util.StringSequenceIdentifier", parameters = {
